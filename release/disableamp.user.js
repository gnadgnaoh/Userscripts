...
// @run-at       document-end
// ==/UserScript==
!function(){"use strict";var t,e,n,r,a=/(amp\/|amp-|\.amp)/,o=function(t){new MutationObserver(t).observe(document,{childList:!0,subtree:!0})},c=function(t){var e=t.querySelector('[aria-label="AMP logo"], [aria-label="Logo AMP"]');e&&(e.style.display="none")},i="https://",u=["ping","data-ved","data-amp-cur","data-amp-title","data-amp","data-amp-vgi"],s="google.";n=(e=document.location).href,r=e.origin,n.includes("https://yandex.ru/turbo")||n.includes("turbopages.org")?function(){var t=document.querySelector('script[data-name="post-message"][data-message]');if(t){var e=t.getAttribute("data-message"),n=JSON.parse(e);n&&n.originalUrl&&(document.location.href=n.originalUrl)}}():(r.includes(s)&&n.includes("/search")&&o((function(){document.querySelectorAll("a[data-amp]").forEach((function(t){u.forEach((function(e){t.removeAttribute(e)}))}))})),r.includes(s)||(t=document.querySelector('head > link[rel="canonical"]'))&&/^https?:\/\/.+/i.test(t.href)&&document.querySelector('script[src^="https://cdn.ampproject.org/"]')&&(document.location.href=t.href),r.includes("news.google.")?o((function(){window.self===window.top&&document.querySelectorAll("article > a[jslog]").forEach((function(t){var e=function(t){var e,n=t.substring(t.indexOf(":")+1,t.indexOf("; track:click,vis"));try{e=JSON.parse(atob(n))}catch(t){}if(!e)return null;var r=e.filter((function(t){return"string"==typeof t&&(t.startsWith("http")||t.startsWith("https"))}));return r.length<2?null:r.find((function(t){return!a.test(t)}))||null}(t.getAttribute("jslog"));e&&function(t,e){t.setAttribute("href",e),t.addEventListener("click",(function(t){t.preventDefault(),t.stopPropagation(),document.location.href=e}),!0),c(t)}(t,e)}))})):o((function(){document.querySelectorAll("a[data-amp-cdn]").forEach((function(t){var e=t.href;e.includes("cdn.ampproject.org")&&(e=i+e.substr(e.indexOf("cdn.ampproject.org/wp/s/")+24)),e.substr(8).startsWith("amp.")&&(e=i+e.substr(12)),(e=e.replace("?amp&","?&"))!==t.href&&(t.setAttribute("href",e),t.addEventListener("click",(function(t){t.preventDefault(),t.stopPropagation(),document.location.href=e}),!0),c(t))}))})))}();